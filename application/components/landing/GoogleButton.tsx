...
export const GoogleButton: React.FC<Props> = ({ buttonText, onClick }) => {
  return (
    <button onClick={onClick} className="flex w-full items-center gap-3 rounded-md border-2 border-alpha-dark-700 p-6">
